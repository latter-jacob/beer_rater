...
#     db_connection do |conn|
#       sql_query = "INSERT INTO beers (name, rating) VALUES ($1, $2)"
#       data = [params["name"], params["rating"]]
...
post "/beers" do
  ...
  rating = params[:rating]
    db_connection {|conn| conn.exec_params ("INSERT INTO beers (name, rating) VALUES ($1, $2)"), [beer, rating]}
  redirect "/beers"
end
